...
class RatingWidgetTest {
    ...
    @Test
    fun passZeroPointZeroValue_Assert_FiveEmptyStarts() {
    ...
    @Test
    fun passZeroPointFiveValue_Assert_FourEmptyStarts_and_OneHalfFilledStar() {
        composeTestRule.setContent {
            RatingWidget(
                modifier = Modifier.padding(all = SMALL_PADDING),
                rating = 0.5
    ...
    @Test
    fun passZeroPointSixValue_Assert_FourEmptyStarts_and_OneFilledStar() {
        composeTestRule.setContent {
            RatingWidget(
                modifier = Modifier.padding(all = SMALL_PADDING),
                rating = 0.6
    ...
    @Test
    fun passFourPointZeroValue_Assert_OneEmptyStart_and_FourFilledStars() {
        composeTestRule.setContent {
            RatingWidget(
                modifier = Modifier.padding(all = SMALL_PADDING),
                rating = 4.0
    ...
    @Test
    fun passNagativeValue_Assert_FiveEmptyStars() {
        composeTestRule.setContent {
            RatingWidget(
                modifier = Modifier.padding(all = SMALL_PADDING),
                rating = -1.5
