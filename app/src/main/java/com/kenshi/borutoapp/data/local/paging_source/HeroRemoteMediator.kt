...
//RemoteDataSourceImpl 를 구현할때 이미 두 의존성을 전달했기 때문에 @Inject constructor 키워드 삭제
class HeroRemoteMediator (
    ...
    private suspend fun getRemoteKeyClosestToCurrentPosition(
        ...
        return state.anchorPosition?.let { position ->
            //closestItemToPosition func actually return hero object
    ...
    // Remember PagingState contains information about the pages loaded so far(지금까지)
